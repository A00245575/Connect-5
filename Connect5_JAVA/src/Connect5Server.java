...
public class Connect5Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Connect 5 Server is Running");
        try {
            while (true) {
                Game game = new Game();
...
class Game {
    ...
    /**
     * A board has 54 squares.  Each square is either unowned or
    ...
    public boolean hasWinner() {
         ...
         */
        for (int i = 0; i < 54; i++) {
            if (board[i] != null && board[i] == board[i + 1] && board[i] == board[i + 2] && board[i] == board[i + 3] && board[i] == board[i + 4]) {
                return true;
            }
        ...
        // Row 1
        for (int i = 0; i < 9; i++) {
            if (board[i] != null && board[i] == board[i + 9] && board[i] == board[i + 18] && board[i] == board[i + 27] && board[i] == board[i + 36]) {
                return true;
            }
        }
        // Row 2
        ...
        // Row 1
        for (int i = 0; i < 4; i++) {
            if (board[i] != null && board[i] == board[i + 10] && board[i] == board[i + 20] && board[i] == board[i + 30] && board[i] == board[i + 40]) {
                return true;
            }
        }
        for (int i = 8; i > 3; i--) {
            if (board[i] != null && board[i] == board[i + 8] && board[i] == board[i + 16] && board[i] == board[i + 24] && board[i] == board[i + 32]) {
                return true;
            }
        }
        // Row 2
